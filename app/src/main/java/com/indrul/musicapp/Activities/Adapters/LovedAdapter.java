...
public class LovedAdapter extends RecyclerView.Adapter<LovedAdapter.ViewHolder> {
    ...
    SearchAdapter.SearchedsongsInterface searchedsongsInterface;
    SearchAdapter.Download download;

    public LovedAdapter(ArrayList<String> track_name, ArrayList<String> artist_name, ArrayList<String> image, ArrayList<String> audio, ArrayList<String> audio_downloaded, SearchAdapter.SearchedsongsInterface searchedsongsInterface, SearchAdapter.Download download) {
