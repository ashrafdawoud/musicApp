...
public class AlbumDetailsAdapter extends RecyclerView.Adapter<AlbumDetailsAdapter.ViewHolder> {
    ...
    public AlbumDetailsAdapter(ArrayList<String> track_name, ArrayList<String> artist_name, ArrayList<String> image, ArrayList<String> audio, ArrayList<String> audio_downloaded, SearchAdapter.SearchedsongsInterface searchedsongsInterface, SearchAdapter.Download download) {
