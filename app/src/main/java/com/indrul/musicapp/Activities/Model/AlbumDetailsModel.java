...
public class AlbumDetailsModel {
    ...
    public AlbumDetailsModel(ArrayList<String> track_name,ArrayList<String>artist_name, ArrayList<String> image, ArrayList<String> audio, ArrayList<String> audio_downloaded) {
